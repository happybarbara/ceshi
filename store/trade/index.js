...
export const useTradeStore = defineStore('trade', {
  ...
  actions: {
    ...
    async getCoinList() {
      ...
      this.secondContractCoinList.splice(0, this.secondContractCoinList.length) // 清空合约币种列表
      this.spotCoinList.splice(0, this.spotCoinList.length) // 清空现货币种列表
      this.contractCoinList.splice(0, this.contractCoinList.length) // 清空合约币种列表
      this.allCoinPriceInfo = {} // 清空价格信息
